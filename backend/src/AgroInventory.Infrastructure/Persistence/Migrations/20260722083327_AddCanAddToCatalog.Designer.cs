...
namespace AgroInventory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260722083327_AddCanAddToCatalog")]
    partial class AddCanAddToCatalog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroInventory.Domain.Entities.CanonicalChemicalCrop", b =>
                {
                    ...
                    b.HasKey("CanonicalChemicalId", "CropId")
                        .HasName("pk_canonical_chemical_crops");

                    b.HasIndex("CropId")
                        .HasDatabaseName("ix_canonical_chemical_crops_crop_id");

                    b.ToTable("canonical_chemical_crops", (string)null);
                });
            ...
            modelBuilder.Entity("AgroInventory.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("CanAddToCatalog")
                        .HasColumnType("boolean")
                        .HasColumnName("can_add_to_catalog");
            ...
            modelBuilder.Entity("AgroInventory.Domain.Entities.CanonicalChemicalCrop", b =>
                {
                    b.HasOne("AgroInventory.Domain.Entities.CanonicalChemical", "CanonicalChemical")
                        .WithMany("CanonicalChemicalCrops")
                        .HasForeignKey("CanonicalChemicalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_canonical_chemical_crops_canonical_chemicals_canonical_chem");
                    ...
                    b.HasOne("AgroInventory.Domain.Entities.Crop", "Crop")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_canonical_chemical_crops_crops_crop_id");
            ...
            modelBuilder.Entity("AgroInventory.Domain.Entities.CanonicalChemical", b =>
                {
                    b.Navigation("CanonicalChemicalCrops");
                });
